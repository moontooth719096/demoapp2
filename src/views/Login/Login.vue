      ...
      <form>
        ...
        <div class="row">
          ...
          <GoogleSignInButton
            ...
            :size="'medium'"
            :text="'signin'"
            :logo_alignment="'left'"></GoogleSignInButton>
...
import { type CredentialResponse, useOneTap, decodeCredential } from "vue3-google-signin";
...
const googleLogin = async (token: string | undefined): Promise<GoogleLoginApiResult> => {
